  ...
  const sizes = [
    {
      label: "Short",
      icon: <FaFile />,
      description: "Around 1–5 ideas. Each idea may include multiple sentences to explain it clearly.",
    },
    {
      label: "Medium",
      icon: <FaFileAlt />,
      description: "Around 6–10 ideas, each developed with enough detail using several sentences.",
    },
    {
      label: "Long",
      icon: <FaFileWord />,
      description: "More than 10 ideas, each thoroughly explained using multiple sentences.",
    },
  ];
